...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__comments__ = __webpack_require__(652);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_socket_io_client__ = __webpack_require__(278);
...
var CommentsPage = /** @class */ (function () {
    function CommentsPage(navCtrl, navParams, postProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.postProvider = postProvider;
        this.commentsArray = [];
        this.socket = __WEBPACK_IMPORTED_MODULE_4_socket_io_client___default()('http://localhost:3000');
    ...
    CommentsPage.prototype.GetSInglePost = function () {
        var _this = this;
        this.postProvider.GetPost(this.post._id).subscribe(function (data) {
    ...
    CommentsPage.prototype.AddComment = function () {
        var _this = this;
        if (this.comment) {
            this.postProvider.AddComment(this.post._id, this.comment).subscribe(function (data) {
                _this.comment = '';
                _this.socket.emit('refresh', {});
            }, function (err) { return console.log(err); });
        }
    };
    CommentsPage.prototype.GetCommentTime = function (time) {
        return __WEBPACK_IMPORTED_MODULE_3_moment___default()(time).fromNow();
    };
    CommentsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-comments',template:/*ion-inline-start:"/Users/User/Desktop/chatapp-ionic-master/src/pages/comments/comments.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Comments</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12>\n        <ion-item class="addPost">\n          <ion-textarea class="message" [(ngModel)]="comment" placeholder="Write Comment"></ion-textarea>\n        </ion-item>\n      </ion-col>\n      <ion-col col-12>\n        <button class="comment" ion-button block (click)="AddComment()">\n          Add Comment\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n  <ion-grid>\n    <ion-row>\n      <ion-list>\n        <ion-item *ngFor="let comment of commentsArray">\n          <ion-avatar item-left>\n            <img class="circle imgCircle" src="http://i.pravatar.cc/300?img=58}">\n          </ion-avatar>\n          <h2 class="username">\n            {{comment.userId.username}}\n          </h2>\n          <p class="postTime">\n            {{GetCommentTime(comment.createdAt)}}\n          </p>\n          <p class="comment">\n            {{comment.comment}}\n          </p>\n        </ion-item>\n      </ion-list>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"/Users/User/Desktop/chatapp-ionic-master/src/pages/comments/comments.html"*/
        }),
