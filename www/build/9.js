...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chat__ = __webpack_require__(651);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_tools_emoji_picker__ = __webpack_require__(283);
...
var ChatPageModule = /** @class */ (function () {
    ...
    ChatPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__chat__["a" /* ChatPage */]), __WEBPACK_IMPORTED_MODULE_3__ionic_tools_emoji_picker__["a" /* EmojiPickerModule */]]
        })
    ], ChatPageModule);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(14), __webpack_require__(277)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_message_message__ = __webpack_require__(281);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__(643);
...
var ChatPage = /** @class */ (function () {
    function ChatPage(navCtrl, navParams, msgProvider, tokenProvider, usersProvider) {
    ...
    ChatPage.prototype.ionViewDidLoad = function () {
        ...
        this.tokenProvider.GetPayload().then(function (value) {
            _this.sender = value;
            _this.GetAllMessages(_this.sender._id, _this.receiverId);
            var val = {
                room: 'global',
                user: _this.sender.username
            };
            _this.socket.emit('online', val);
            var params = {
                room1: _this.sender.username,
                room2: _this.receiverName
            };
            _this.socket.emit('join chat', params);
        });
    ...
    ChatPage.prototype.GetAllMessages = function (senderId, receiverId) {
        var _this = this;
        this.msgProvider.GetAllMessages(senderId, receiverId).subscribe(function (data) {
            _this.msgArray = data.messages.message;
        });
    };
    ChatPage.prototype.GetReceiverData = function () {
        var _this = this;
        this.usersProvider.GetUserByName(this.receiverName).subscribe(function (data) {
            _this.receiver = data.result;
        });
    };
    ChatPage.prototype.SocketFunction = function () {
        var _this = this;
        ...
        this.socket.on('usersOnline', function (data) {
            var result = __WEBPACK_IMPORTED_MODULE_6_lodash___default.a.indexOf(data, _this.receiverName);
            if (result > -1) {
                _this.isOnline = true;
            }
            else {
    ...
    ChatPage.prototype.PrivateMessage = function () {
        var _this = this;
        if (!this.message) {
            return;
        }
        this.msgProvider
            .SendMessage(this.sender._id, this.receiverId, this.receiverName, this.message)
    ...
    ChatPage.prototype.GoToBottom = function () {
        var _this = this;
        setTimeout(function () {
            if (_this.contentDiv._scroll) {
                _this.contentDiv.scrollToBottom();
            }
        }, 500);
    };
    __decorate([
    ...
    ChatPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["j" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_0__providers_users_users__["a" /* UsersProvider */]])
    ], ChatPage);
    return ChatPage;
}());
